...
-->
<template>
    <a-drawer :title="form.machineId ? '编辑机器' : '新增机器'" :width="500" :open="visible" :body-style="{ paddingBottom: '80px' }" @close="onClose">
  ...
  import { MACHINE_STATUS_ENUM } from '/@/constants/business/erp/machine-const';
